        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Have questions about our platform? Want to collaborate? We'd love
              to hear from you.
            </p>
          </motion.div>
                ...
                <div className="space-y-6">
                  {[
                    ...
                    },
                    {
                      ...
                      description:
                        "Submit your portfolio and join our community",
                    },
                    {
                      title: "Partnerships",
              ...
              {[
                {
                  ...
                  answer:
                    "Submit your portfolio through our artist application form. We review applications monthly and will contact you within 2 weeks.",
                },
                {
                  question: "What are the fees for selling NFTs?",
                  answer:
                    "We charge a 2.5% platform fee on successful sales. Gas fees are paid by the buyer during transactions.",
                },
                {
                  question: "How do I become a verified collector?",
                  answer:
                    "Collectors are verified based on their transaction history and community engagement. Apply through our collector program.",
                },
                {
                  question: "What blockchain do you support?",
                  answer:
                    "We currently support Ethereum and Polygon networks, with plans to expand to other chains soon.",
                },
              ].map((faq, index) => (
                <motion.div
                  key={faq.question}
