              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  >
                    ...
                    <input
                      ...
                      className="w-full bg-gray-900 border border-gray-700 rounded-lg px-4 py-3 text-white focus:border-white focus:outline-none transition-colors"
                      required
                    />
                  </motion.div>
                  <motion.div
                ...
                >
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={6}
                    className="w-full bg-gray-900 border border-gray-700 rounded-lg px-4 py-3 text-white focus:border-white focus:outline-none transition-colors resize-none"
                    required
                  />
                </motion.div>
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  type="submit"
                  className="w-full bg-white text-black px-8 py-4 text-lg font-medium hover:bg-gray-200 transition-colors"
                >
                  Send Message
                </motion.button>
              </form>
