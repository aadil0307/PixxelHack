...
export const featuredNFTs: NFT[] = [
  {
    ...
    description: "A mesmerizing exploration of digital consciousness and artificial intelligence.",
  ...
  },
  {
    ...
    price: "1.8 ETH",
    category: "Abstract",
    description: "Vibrant colors dance in perfect harmony, creating visual poetry.",
  ...
  },
  {
    ...
    price: "3.2 ETH",
    category: "Cyberpunk",
    description: "A neon-lit cityscape that captures the essence of digital rebellion.",
  ...
  },
  {
    ...
    description: "Visual representation of quantum mechanics and particle physics.",
